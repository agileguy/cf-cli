...
const USAGE = `Usage: cf access groups <command>
...
Run 'cf access groups <command> --help' for more information.`;
...
export async function run(args: string[], ctx: Context): Promise<void> {
  ...
  switch (subcommand) {
    ...
    case "-h":
      ...
      return;
    default:
      throw new UsageError(`Unknown access groups command: "${subcommand}"\n\n${USAGE}`);
  }
}
