import type { Context, PageShieldConnection, ColumnDef } from "../../../types/index.js";
...
export async function run(args: string[], ctx: Context): Promise<void> {
  ...
  const connections = await ctx.client.get<PageShieldConnection[]>(
    `/zones/${encodeURIComponent(zoneId)}/page_shield/connections`,
  );
  ...
  ctx.output.table(connections, columns);
}
