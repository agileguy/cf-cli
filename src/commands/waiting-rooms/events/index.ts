...
const USAGE = `Usage: cf waiting-rooms events <command>
...
Run 'cf waiting-rooms events <command> --help' for more information.`;
...
export async function run(args: string[], ctx: Context): Promise<void> {
  ...
  switch (subcommand) {
    ...
    case "-h":
      ...
      return;
    default:
      throw new UsageError(`Unknown waiting-rooms events command: "${subcommand}"\n\n${USAGE}`);
  }
}
