...
const USAGE = `Usage: cf spectrum apps <command>
...
Run 'cf spectrum apps <command> --help' for more information.`;
...
export async function run(args: string[], ctx: Context): Promise<void> {
  ...
  switch (subcommand) {
    ...
    case "-h":
      ...
      return;
    default:
      throw new UsageError(`Unknown spectrum apps command: "${subcommand}"\n\n${USAGE}`);
  }
}
