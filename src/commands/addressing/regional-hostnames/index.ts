...
const USAGE = `Usage: cf addressing regional-hostnames <command>
...
Run 'cf addressing regional-hostnames <command> --help' for more information.`;
...
export async function run(args: string[], ctx: Context): Promise<void> {
  ...
  switch (subcommand) {
    ...
    case "-h":
      ...
      return;
    default:
      throw new UsageError(`Unknown regional-hostnames command: "${subcommand}"\n\n${USAGE}`);
  }
}
